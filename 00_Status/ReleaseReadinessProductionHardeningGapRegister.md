...
- Notifications/diagnostics: notification preferences and private previews may be ahead of delivery implementation; diagnostics payload privacy, retention, and support visibility remain unresolved.
...
| RR-GAP-010 | NPR gaps; LTS-GAP-004; PRV-GAP-005 | Notification, Legal Policy, Privacy | Notifications / push / reminders | Notification preferences/private previews may not be consumed by delivery; push payload privacy, token deletion, reminder retention, and Edge deployment are unresolved | Prior audits; delivery deployment unknown | Privacy-sensitive | Candidate P1 | Pre-launch hardening candidate; Production verification required | Push delivery/preference verification | Create notification delivery/privacy verification pack | PP-06 |
...
- RR-GAP-010: notification preference/private-preview delivery mismatch.
