...
- AUTH_REDIRECT_ALLOWLIST: PASS_WITH_LEGACY_CLEANUP_REQUIRED
- AUTH_HOOKS: NONE
- AUTH_EMAIL_LOGO_ASSET: PASS
- AUTH_CONFIRMATION_EMAIL_UAT: PASS_WITH_VISUAL_FIX_REQUIRED
...
- AUTH_EMAIL_TEMPLATES: IMPLEMENTED_UAT_PARTIAL
- AUTH_EMAIL_IMPLEMENTATION: AUTHORIZED_UNDER_ACCEPTED_BROWSER_FIRST_PATCH_PLAN
- AUTH_EMAIL_DOMAIN_OVERALL: ACTIVE_CLOSURE
